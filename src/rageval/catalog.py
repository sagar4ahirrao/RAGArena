...
PROVIDERS: Dict[str, ProviderConfig] = {
    ...
    "google":       ProviderConfig("Google AI Studio", "https://generativelanguage.googleapis.com/v1beta", "GEMINI_API_KEY"),
...
CHAT_MODELS: List[ModelInfo] = [
    ...
    _m("google/gemini-1.5-flash", "google", "gemini-1.5-flash", context_window=1048576,
       input_cost=0.075, output_cost=0.30, supports_vision=True, description="Very fast + cheap"),
    _m("google/gemini-1.0-pro", "google", "gemini-1.0-pro", context_window=32768,
    ...
    # ── Meta Llama family (via fast hosts) ──
    _m("groq/llama-3.1-70b-versatile", "groq", "llama-3.1-70b-versatile", context_window=131072,
       input_cost=0.59, output_cost=0.79, description="Llama 3.1 70B at 300+ tok/s"),
    _m("groq/llama-3.1-8b-instant", "groq", "llama-3.1-8b-instant", context_window=131072,
       input_cost=0.05, output_cost=0.08, description="Sub-second latency"),
    _m("groq/mixtral-8x7b-32768", "groq", "mixtral-8x7b-32768", context_window=32768,
...
EMBEDDING_MODELS: List[ModelInfo] = [
    ...
    _m("google/text-embedding-004", "google", "text-embedding-004", modality="embedding",
       input_cost=0.0, description="Gemini embeddings (768-d)"),
